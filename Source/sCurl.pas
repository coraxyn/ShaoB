...
implementation
  ...
  begin
    ...
    try
      ...
      curl_easy_setopt( fCurlp, CURLOPT_RANGE, [ '0-4000' + #00 ] );                        // Turn verbose off
      ...
      curl_easy_setopt( fCurlp, CURLOPT_MAXFILESIZE, [ 1024 * 100 ] );                // Read maximum 50k in.  This is to eliminate DoS via long headers or content
      ...
      if j = CURLE_OK then begin
        ...
        fIRC.Pending := fUserName + '> ' + strPas( p );
        fCon.Send( 'P is done', taNormal );
      end;
      curl_easy_cleanup( fCurlp );

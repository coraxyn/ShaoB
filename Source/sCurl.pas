...
implementation
  ...
  function tCurl.Get( s : string; a : array of string ) : string;
    ...
    // a is dynamic array of custom header strings like 'Custom_header: some_vcalue'
  var
    b : pcurl_sList;
    i : integer;
    t : string;
  begin
    ...
    try
      ...
      curl_easy_setopt( fCurlp, CURLOPT_MAXFILESIZE, [ 1024 * 50 ] );                // Read maximum 20k in.  This is to eliminate DoS via long headers or content
